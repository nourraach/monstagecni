        ...
        <?php if (!empty($users)): ?>
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($user['role']) ?></td> <!-- Added Role data -->
                    <td>
                        <a href="edit_user.php?id=<?= $user['id'] ?>" class="btn btn-edit btn-sm">Edit</a>
                        <a href="delete_user.php?id=<?= $user['id'] ?>" class="btn btn-delete btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
                <td colspan="6" class="text-center">No users found.</td> <!-- Updated colspan to 6 -->
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
